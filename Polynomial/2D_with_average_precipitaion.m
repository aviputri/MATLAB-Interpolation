...
title(['nearest Nav=',num2str(round(Naverage))]);
...
title(['Bilinear Nav=',num2str(round(Naverage))]);
...
title(['Cubic Nav=',num2str(round(Naverage))]);
...
title(['Spline Nav=',num2str(round(Naverage))]);
